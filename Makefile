...
sprint-current:
	...
	@echo ""
	@echo "  sprintctl render > docs/sprint/current.md"
	@echo ""
	@echo "To view current sprint state in terminal:"
	@echo ""
	@echo "  sprintctl sprint show --detail"
	@echo "  sprintctl item list --sprint-id <id>"
	@echo ""
...
knowledge-status:
	...
	@echo ""
	@echo "  sprintctl event list --sprint-id <id> --type pattern-noted"
	@echo "  sprintctl event list --sprint-id <id> --type lesson-learned"
	@echo ""
...
agent-entry:
	...
	@echo "  2. sprintctl sprint show --detail"
	@echo "  3. sprintctl item list --sprint-id <id>"
	@echo "  4. sprintctl claim list-sprint --sprint-id <id>"
	@echo "  5. Read handoff notes on items you're picking up:"
	@echo "       sprintctl item show --id <item-id>"
	@echo "  6. sprintctl item list --sprint-id <id> --status blocked"
	@echo "  7. Identify your track for this session"
	@echo "  8. Claim before starting: sprintctl claim create --item-id <id> --actor <you> --json"
	@echo ""
